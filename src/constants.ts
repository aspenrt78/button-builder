...
export const ANIMATION_OPTIONS = [
  ...
  { value: 'auroraBorder', label: 'Aurora Border' },
  { value: 'cometBorder', label: 'Comet Border' },
  { value: 'energyCharge', label: 'Energy Charge' },
  { value: 'neonCurrent', label: 'Neon Current' },
  { value: 'scanner', label: 'Scanner' },
  { value: 'shimmer', label: 'Shimmer' },
  { value: 'liquidGradient', label: 'Liquid Gradient' },
  { value: 'meshGradient', label: 'Mesh Gradient' },
  { value: 'plasma', label: 'Plasma' },
  { value: 'starfield', label: 'Starfield' },
  { value: 'embers', label: 'Embers' },
  { value: 'rain', label: 'Rain' },
  { value: 'radarPulse', label: 'Radar Pulse' },
  { value: 'sonarRings', label: 'Sonar Rings' },
  { value: 'statusBeacon', label: 'Status Beacon' },
  { value: 'glitch', label: 'Glitch' },
  { value: 'electricJolt', label: 'Electric Jolt' },
  { value: 'frost', label: 'Frost' },
  { value: 'heatHaze', label: 'Heat Haze' },
  { value: 'breathingGlass', label: 'Breathing Glass' },
  { value: 'magneticHover', label: 'Magnetic Hover' },
  { value: 'iconOrbit', label: 'Icon Orbit' },
  { value: 'iconDraw', label: 'Icon Draw' },
  { value: 'stateMorph', label: 'State Morph' },
  { value: 'progressBorder', label: 'Progress Border' },
  { value: 'thresholdPulse', label: 'Threshold Pulse' },
];
